...
CPA 1차 시험(재무회계·세법·원가) 준비 과정에서 자투리 시간을 학습 시간으로 바꾸기 위해 만든 Streamlit 기반 암기장 & 퀴즈 앱입니다.
...
이 도구를 실제로 활용하며 CPA 1차 재무회계·재무관리·회계감사 과목에 합격했습니다. 이동 시간을 학습 시간으로 전환한 것이 실질적인 효과가 있었습니다.
